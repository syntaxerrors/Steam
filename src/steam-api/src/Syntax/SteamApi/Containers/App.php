...
class App {
	...
	public function __construct($app)
	{
		...
		$this->developers         = isset($app->developers) ? new \Utility_Collection($app->developers) : null;
		$this->publishers         = new \Utility_Collection($app->publishers);
		...
		$this->categories         = isset($app->categories) ? new \Utility_Collection($app->categories) : null;
		$this->genres             = isset($app->genres) ? new \Utility_Collection($app->genres) : null;
