...
class Game {
	...
	public function __construct($app)
	{
		...
		$this->playtimeTwoWeeks         = isset($app->playtime_2weeks) ? convertFromMinutes($app->playtime_2weeks) : '0 minutes';
		$this->playtimeForever          = isset($app->playtime_forever) ? $app->playtime_forever : 0;
		$this->playtimeForeverReadable  = convertFromMinutes($this->playtimeForever);
