...
class Steam_User extends Client {
	...
	public function GetFriendList($relationship = 'all')
	{
		...
		// Set up the arguments
		$arguments = 'steamid='. $this->steamId .'&relationship='. $relationship;
	...
	protected function convertToObjects($players)
	{
		...
		foreach ($players as $player) {
			$cleanedPlayers[] = new Containers\Player($player);
		}
